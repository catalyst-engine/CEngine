...
int main(int, char **) {
    ...
    ImFont *robotoDefault = io.Fonts->AddFontFromFileTTF("../static/Roboto/Roboto-Regular.ttf", 16.0f);
    ImFont *robotoBold = io.Fonts->AddFontFromFileTTF("../static/Roboto/Roboto-Bold.ttf", 16.0f);
