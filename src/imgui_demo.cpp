...
// [SECTION] Example App: Long TextComponent / ShowExampleAppLongText()
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        // (otherwise a TextComponent+SameLine+Button sequence will have the text a little too high by default!)
        // See 'Demo->Layout->TextComponent Baseline Alignment' for details.
...

        {
            ...
            // see the "TextComponent Input > Resize Callback" section of this demo, and the misc/cpp/imgui_stdlib.h file.
    ...
    if (ImGui::TreeNode("Tooltips"))
    {
        ...
        // - Short-form (any contents):   if (BeginItemTooltip()) { TextComponent("Hello"); EndTooltip(); }

        // - Full-form (text only):       if (IsItemHovered(...)) { SetTooltip("Hello"); }
        // - Full-form (any contents):    if (IsItemHovered(...) && BeginTooltip()) { TextComponent("Hello"); EndTooltip(); }
    ...
    //for (int i = 0; i < 5; i++)
    //    if (once)
    //        ImGui::TextComponent("This will be displayed only once.");
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                else
                {
                    ...
                    // use BulletText() or advance the cursor by GetTreeNodeToLabelSpacing() and call TextComponent().
    ...
    if (ImGui::TreeNode("Collapsing Headers"))
    {
        ...
        if (ImGui::CollapsingHeader("Header with a bullet", ImGuiTreeNodeFlags_Bullet))
            ImGui::TextComponent("IsItemHovered: %d", ImGui::IsItemHovered());
        */
        ImGui::TreePop();
    }
    ...
    IMGUI_DEMO_MARKER("Widgets/TextComponent");
    if (ImGui::TreeNode("TextComponent"))
    {
        IMGUI_DEMO_MARKER("Widgets/TextComponent/Colored TextComponent");
        if (ImGui::TreeNode("Colorful TextComponent"))
        {
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent/Word Wrapping");
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent/UTF-8 TextComponent");
        if (ImGui::TreeNode("UTF-8 TextComponent"))
        {
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        float my_tex_h = (float)io.Fonts->TexHeight;
        {
            ...
            ImGui::Checkbox("Use TextComponent Color for Tint", &use_text_color_for_tint);
    ...
    // To wire InputText() with std::string or any other custom string type,
    // see the "TextComponent Input > Resize Callback" section of this demo, and the misc/cpp/imgui_stdlib.h file.
    IMGUI_DEMO_MARKER("Widgets/TextComponent Input");
    if (ImGui::TreeNode("TextComponent Input"))
    {
        IMGUI_DEMO_MARKER("Widgets/TextComponent Input/Multi-line TextComponent Input");
        if (ImGui::TreeNode("Multi-line TextComponent Input"))
        {
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent Input/Filtered TextComponent Input");
        if (ImGui::TreeNode("Filtered TextComponent Input"))
        {
            struct TextFilters
            {
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent Input/Password input");
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent Input/Completion, History, Edit Callbacks");
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent Input/Resize Callback");
        ...
        IMGUI_DEMO_MARKER("Widgets/TextComponent Input/Miscellaneous");
    ...
    if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)"))
    {
        ...
        {
            "TextComponent", "Button", "Button (w/ repeat)", "Checkbox", "SliderFloat", "InputText", "InputTextMultiline", "InputFloat",
        ...
        if (item_type == 0) { ImGui::Text("ITEM: TextComponent"); }                                              // Testing text items with no identifier/interaction
    ...
    IMGUI_DEMO_MARKER("Widgets/Disable BlockComponent");
    ...
    IMGUI_DEMO_MARKER("Widgets/TextComponent Filter");
    if (ImGui::TreeNode("TextComponent Filter"))
    {
...
static void ShowDemoWindowLayout()
{
    ...
    IMGUI_DEMO_MARKER("Layout/TextComponent Baseline Alignment");
    if (ImGui::TreeNode("TextComponent Baseline Alignment"))
    {
        {
            ImGui::BulletText("TextComponent baseline:");
            ImGui::SameLine(); HelpMarker(
            ...
            // (because we don't know what's coming after the TextComponent() statement, we need to move the text baseline
            ...
            // SmallButton() uses the same vertical padding as TextComponent
            ...
            // If your line starts with text, call AlignTextToFramePadding() to align text to upcoming widgets.
            ImGui::AlignTextToFramePadding();
            ImGui::Text("TextComponent aligned to framed item"); ImGui::SameLine();
...

        {
            ...
            // SmallButton() sets FramePadding to zero. TextComponent baseline is aligned to match baseline of previous Button.
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Checkbox("TextComponent wrapped", &show_text_wrapped);// Will grow and use contents size
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Context menus"))
    {
        ...
        // Example 2
        // Popup on a TextComponent() element which doesn't have an identifier: we need to provide an identifier to BeginPopupContextItem().
        // Using an explicit identifier is also convenient if you want to activate the popups from different locations.
        {
            HelpMarker("TextComponent() elements don't have stable identifiers so we need to provide one.");
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Borders, background"))
    {
        ...
        ImGui::SameLine(); ImGui::RadioButton("TextComponent", &contents_type, CT_Text);
    ...
    if (ImGui::TreeNode("Sizing policies"))
    {
        ...
        ImGui::Combo("Contents", &contents_type, "Show width\0Short TextComponent\0Long TextComponent\0Button\0Fill Button\0InputText\0");
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        const char* contents_type_names[] = { "TextComponent", "Button", "SmallButton", "FillButton", "Selectable", "Selectable (span row)" };
        static int freeze_cols = 1;
        static int freeze_rows = 1;
...
void ImGui::ShowAboutWindow(bool* p_open)
{
    ...
    if (show_config_info)
    {
        ...
        ImGui::TextComponent("define: IMGUI_DISABLE_OBSOLETE_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_OBSOLETE_KEYIO
        ImGui::TextComponent("define: IMGUI_DISABLE_OBSOLETE_KEYIO");
#endif
#ifdef IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_WIN32_DEFAULT_CLIPBOARD_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_WIN32_DEFAULT_IME_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_WIN32_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_WIN32_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_DEFAULT_FORMAT_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_DEFAULT_FORMAT_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_DEFAULT_MATH_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_DEFAULT_MATH_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_DEFAULT_FILE_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_DEFAULT_FILE_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_FILE_FUNCTIONS
        ImGui::TextComponent("define: IMGUI_DISABLE_FILE_FUNCTIONS");
#endif
#ifdef IMGUI_DISABLE_DEFAULT_ALLOCATORS
        ImGui::TextComponent("define: IMGUI_DISABLE_DEFAULT_ALLOCATORS");
#endif
#ifdef IMGUI_USE_BGRA_PACKED_COLOR
        ImGui::TextComponent("define: IMGUI_USE_BGRA_PACKED_COLOR");
#endif
#ifdef _WIN32
...
#endif
#ifdef __linux__
        ImGui::TextComponent("define: __linux__");
#endif
#ifdef __APPLE__
        ImGui::TextComponent("define: __APPLE__");
#endif
#ifdef _MSC_VER
        ImGui::TextComponent("define: _MSC_VER=%d", _MSC_VER);
#endif
#ifdef _MSVC_LANG
        ImGui::TextComponent("define: _MSVC_LANG=%d", (int)_MSVC_LANG);
#endif
#ifdef __MINGW32__
        ...
        ImGui::TextComponent("define: __clang_version__=%s", __clang_version__);
#endif
#ifdef __EMSCRIPTEN__
        ImGui::TextComponent("define: __EMSCRIPTEN__");
#endif
...
static void ShowExampleMenuFile()
{
    ...
    if (ImGui::BeginMenu("Options"))
    {
        ...
        for (int i = 0; i < 10; i++)
            ImGui::Text("Scrolling TextComponent %d", i);
        ImGui::EndChild();
        static float f = 0.5f;
        static int n = 0;
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::SmallButton("Add Debug TextComponent"))  { AddLog("%d some text", Items.Size); AddLog("some more text"); AddLog("display very important message here!"); }
        ImGui::SameLine();
...
static void ShowPlaceholderObject(const char* prefix, int uid)
{
    ...
    // TextComponent and Tree nodes are less high than framed widgets, using AlignTextToFramePadding() we add vertical spacing to make the tree lines equal high.
    ImGui::TableNextRow();
    ImGui::TableSetColumnIndex(0);
    ImGui::AlignTextToFramePadding();
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    ImGui::Combo("Test type", &test_type,
        ...
        "Multiple calls to TextComponent(), clipped\0"
        "Multiple calls to TextComponent(), not clipped (slow)\0");
    ...
    case 1:
        {
            // Multiple calls to TextComponent(), manually coarsely clipped - demonstrate how to use the ImGuiListClipper helper.
            ImGui::PushStyleVar(ImGuiStyleVar_ItemSpacing, ImVec2(0, 0));
            ImGuiListClipper clipper;
            clipper.Begin(lines);
            while (clipper.Step())
    ...
    case 2:
        // Multiple calls to TextComponent(), not clipped (slow)
        ImGui::PushStyleVar(ImGuiStyleVar_ItemSpacing, ImVec2(0, 0));
