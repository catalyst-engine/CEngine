...
class Test : public Catalyst::IElement {
public:
...
TEST_CASE("Should add child", "[document-add-child]") {
    ...
    Catalyst::IElement *found = document.getElementById("c");
...
TEST_CASE("Should find deep child", "[document-getbyid]") {
    ...
    Catalyst::IElement *found5 = document.getElementById("5");
    Catalyst::IElement *found4 = document.getElementById("4");
    Catalyst::IElement *found3 = document.getElementById("3");
    Catalyst::IElement *found2 = document.getElementById("2");
    Catalyst::IElement *found1 = document.getElementById("1");
